    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("Logging the training andd test dataset to MLFLOW")
                mlflow.log_artifact(self.train_path, artifact_path="datasets")  #hangi model hangi ata ile eğitildi experiment tracking for train data
